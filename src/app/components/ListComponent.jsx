                ...
                <main className="flex flex-col w-full">
                    ...
                    <div className="flex justify-between items-center bg-white p-4 shadow">
                        <div className="flex flex-col gap-1">
                            ...
                            <h6 className="font-normal">Showing slots in the 12 am to 11 pm window.</h6>
                        </div>
                            ...
                            filteredProviders.map((provider, idx) => (
                                <div key={idx} className="p-6 flex gap-4 w-full">
                                    ...
                                    <div className="flex w-[80%] border border-[#E0E0E0] rounded-lg items-center">
                                        ...
                                        <div
                                            className="border-r border-l border-[#E0E0E0] h-full overflow-auto grid gap-2 w-full p-4"
                                            style={{
